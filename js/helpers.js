...
function changeHeightChatBlock() {
	...
	$('.panel-body', $("#wrap") ).height(window.innerHeight - outerHeightWrapHeader);
	$('.messages, .col-content', $("#wrap")).height(window.innerHeight - outerHeightWrapHeader - outerHeightControls);
	$('.users', $("#wrap")).height(window.innerHeight - outerHeightWrapHeader - outerHeightControls - outerHeightWell);
}
